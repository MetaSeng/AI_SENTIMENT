...
def health():
    return {
        ...
        "sentiment_model_source": sentiment_service.sentiment_model_source,
        "sentiment_weights_loaded": sentiment_service.sentiment_weights_loaded,
        "language_tagger_loaded": sentiment_service.language_tagger_loaded,
